...
// Default extensions from eslint-plugin-html (hardcoded to avoid importing private API paths)
...
const allScriptRules = defineConfig([
  ...
  // eslint-plugin-n
  {
    name: 'scratch/allScriptRules[eslint-plugin-n]',
  ...
  // eslint-plugin-react
  {
    name: 'scratch/allScriptRules[eslint-plugin-react/jsx-filename-extension]',
...
const typeFreeRules = defineConfig([
  ...
  ...allScriptRules,
  {
    name: 'scratch/typeFreeRules[@eslint/js]',
    rules: {
      // https://eslint.org/docs/latest/rules/no-unused-vars
      // Standard ignore patterns: prefix unused identifiers with `_` to suppress the error.
      // TypeScript files in `recommended` get this overridden by @typescript-eslint/no-unused-vars
      // (via typeCheckedRules), which has the same patterns.
      'no-unused-vars': [
        'error',
        {
          argsIgnorePattern: '^_',
...
const typeCheckedRules = defineConfig([
  ...
  // typescript-eslint
  {
    ...
    rules: {
      ...
      // TypeScript's own checks (and type narrowing with asserts) make this rule noisy.
